...
const mockTeams = {
  "alpha": { 
    ...
    members: [
      { id: "user1", name: "Alex Johnson", avatar: "AJ", role: "admin" },
      { id: "user2", name: "Sam Taylor", avatar: "ST", role: "member" },
      { id: "user3", name: "Jordan Lee", avatar: "JL", role: "member" },
    ]
  },
  "bravo": { 
    id: "bravo", 
    ...
    members: [
      { id: "user2", name: "Sam Taylor", avatar: "ST", role: "admin" },
      { id: "user4", name: "Casey Morgan", avatar: "CM", role: "member" },
    ]
  },
};
...
const mockUsers = [
  ...
  { id: "user5", name: "Riley Smith", avatar: "RS", streak: 15, isFriend: true },
];
      ...
      <div style={{
        ...
        <Link 
          ...
          style={{
            ...
            background: theme === 'dark' ? "transparent" : "rgba(219, 234, 254, 0.5)",
            padding: "0.5rem 0.75rem",
            borderRadius: "0.375rem",
            border: theme === 'dark' ? "none" : "1px solid rgba(147, 197, 253, 0.5)",
            textDecoration: "none",
            fontSize: "0.875rem",
            fontWeight: 500,
            transition: "all 0.2s ease"
          ...
          <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: "0 0 200px" }}>
              ...
              <div style={{
                ...
                cursor: "pointer",
                overflow: "hidden",
                background: logoPreview || teamLogo ? "transparent" : theme === 'dark' ? "rgba(30, 41, 59, 0.4)" : "rgba(241, 245, 249, 0.7)",
                position: "relative",
              }}>
                {logoPreview ? (
                  <img 
                  ...
                  <>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: "#94a3b8", marginBottom: "0.5rem" }}>
